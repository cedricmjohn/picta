...
object XYTrace {
  ...
  * */
  final case class XY[T0: Serializer, T1: Serializer](x: List[T0], y: List[T1], xkey: String = "x", ykey: String = "y",
                                                       trace_name: String, trace_type: XYChartType = SCATTER,
                                                       trace_mode: Option[String] = None, xaxis: String = "x",
                                                       yaxis: String = "y", marker: Option[Marker] = None) extends XYTrace {
    ...
    def serialize(): Value = {
      ...
      meta.obj ++ axes.obj ++ t.obj ++ m.obj ++ createSeries().obj
    }
  }
